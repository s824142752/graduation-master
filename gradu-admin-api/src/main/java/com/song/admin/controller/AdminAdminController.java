...
import com.song.core.util.RegexUtil;
...
public class AdminAdminController {
    ...
    public Object list(String username,
                       ...
                       @Order @RequestParam(defaultValue = "desc") String order) {   //@Order 排序
        List<GraduAdmin> adminList = adminService.querySelective(username, page, limit, sort, order);
        return ResponseUtil.okList(adminList);
    }

    private Object validate(GraduAdmin admin) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody GraduAdmin admin) {
    ...
    public Object read(@NotNull Integer id) {
        GraduAdmin admin = adminService.findById(id);
        return ResponseUtil.ok(admin);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody GraduAdmin admin) {
        Object error = validate(admin);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody GraduAdmin admin) {
        Integer anotherAdminId = admin.getId();
        if (anotherAdminId == null) {
            return ResponseUtil.badArgument();
        }
        ...
        GraduAdmin currentAdmin = (GraduAdmin) currentUser.getPrincipal();
