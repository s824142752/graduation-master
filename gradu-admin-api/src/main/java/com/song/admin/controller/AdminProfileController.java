...
import static com.song.admin.util.AdminResponseCode.ADMIN_INVALID_ACCOUNT;
...
public class AdminProfileController {
    ...
    public Object lsNotice(String title, String type,
        ...
        List<GraduNoticeAdmin> noticeList = noticeAdminService.querySelective(title, type, getAdminId(), page, limit, sort, order);
    ...
    public Object catNotice(@RequestBody String body) {
        ...
        GraduNoticeAdmin noticeAdmin = noticeAdminService.find(noticeId, getAdminId());
        if(noticeAdmin == null){
        ...
        GraduNotice notice = noticeService.findById(noticeId);
        ...
        if(adminId.equals(0)){
            ...
            GraduAdmin admin = adminService.findById(notice.getAdminId());
