...
import com.song.wx.service.CaptchaCodeManager;
import com.song.wx.service.UserTokenManager;
import com.song.wx.util.WxResponseCode;
import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import com.song.core.notify.NotifyService;
import com.song.core.util.JacksonUtil;
import com.song.core.util.ResponseUtil;
import com.song.wx.dto.WxLoginInfo;
...
//    private CouponAssignService couponAssignService;
    ...
    public Object login(@RequestBody String body, HttpServletRequest request) {
        ...
        List<GraduUser> userList = userService.queryByUsername(username);
        GraduUser user = null;
        if (userList.size() > 1) {
    ...
    public Object loginByWeixin(@RequestBody WxLoginInfo wxLoginInfo, HttpServletRequest request) {
        ...
        GraduUser user = userService.queryByOid(openId);
        if (user == null) {
            user = new GraduUser();
...
//            }
//            if (userList.size() == 1) {
//                GraduUser checkUser = userList.get(0);
...
//    }
    ...
    public Object reset(@RequestBody String body, HttpServletRequest request) {
        ...
        List<GraduUser> userList = userService.queryByMobile(mobile);
        GraduUser user = null;
        if (userList.size() > 1) {
            return ResponseUtil.serious();
        } else if (userList.size() == 0) {
