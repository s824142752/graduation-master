...
import com.song.core.storage.AliyunStorage;
...
public class AliyunStorageTest {
    ...
    public void test() throws IOException {
        ...
        aliyunStorage.store(new FileInputStream(test), testFile.length(), "image/png", "gradu.png");
        Resource resource = aliyunStorage.loadAsResource("gradu.png");
        String url = aliyunStorage.generateUrl("gradu.png");
